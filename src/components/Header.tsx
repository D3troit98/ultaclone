...
const Header = () => {
  ...
  return (
    <div className='flex justify-between items-center w-full h-16 px-24 py-4 bg-white border-b  border-b-gray-200' >

      <div className='flex items-center gap-5 h-full '>
        <AiOutlineMenu className='h-full cursor-pointer w-full' />
        <div className='w-1 h-full   border-r border-b-gray-200' />
        <Image src={Logo} alt="logo" className='h-full   orange-filter' sizes="(max-width: 768px) 100vw,
              (max-width: 1200px) 50vw,
              33vw" />
        <div
      className={`flex items-center rounded-full h-8 px-3 bg-gray-200 w-64 border-2 border-transparent ${
