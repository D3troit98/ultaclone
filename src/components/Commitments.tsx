...
const Commitments = () => {
  return (
    <div className="flex flex-col bg-[#ffffff] w-full  px-20 pt-20">
      <div className="flex justify-start items-center ">
        <h1 className="font-circular-std-medium text-2xl font-medium text-start">
          Our Corperate commitments
        </h1>
      </div>

      <div className="flex flex-wrap justify-evenly items-start mt-8">
